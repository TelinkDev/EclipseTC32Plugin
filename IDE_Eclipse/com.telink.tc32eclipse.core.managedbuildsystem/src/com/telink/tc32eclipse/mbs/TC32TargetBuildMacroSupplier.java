 ...
 * Purpose:
 * Reference :    
 * $Id: TC32TargetBuildMacroSupplier.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
 ...
 * @since 1.0
 */
public class TC32TargetBuildMacroSupplier implements IConfigurationBuildMacroSupplier {
	 ...
	 * </p>
	 * <p>
	 * TC32TargetBuildMacros can have an optional parameter to retrive the value
	 ...
	 * </p>
	 * <p>
	 * If the target project is not an TC32 project, some build macros will
