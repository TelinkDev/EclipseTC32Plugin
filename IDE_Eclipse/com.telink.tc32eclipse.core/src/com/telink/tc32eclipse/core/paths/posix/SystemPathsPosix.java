 ...
 * Purpose:
 * Reference : 
 * $Id: SystemPathsPosix.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/

package com.telink.tc32eclipse.core.paths.posix;
...
/**
 * Gets the actual system paths to the tc32-elf-gcc Toolchain and some config files.
 * 
...
public class SystemPathsPosix {
	...
	// /etc/ was used to find the PCDB.conf file. While this is currently not
	...
	public static IPath getSystemPath(TC32Path TC32path) {
		...
		if (!path.isEmpty()) {
			...
			// the path. This makes a test like "TC32/tc32.h" work
