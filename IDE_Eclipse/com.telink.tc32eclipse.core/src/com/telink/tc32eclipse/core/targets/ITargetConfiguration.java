 ...
 * Purpose:
 * Reference :   
 * $Id: ITargetConfiguration.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
 ...
 * <li>The target MCU type.</li>
 * <li>An ID for the programmer hardware used to access the MCU, including its host and target
 * interface settings.</li>
 * <li>The ID of the programmer tool for uploading TC32 applications to the target MCU.</li>
 * <li>The ID of the gdbserver tool for debugging TC32 applications.</li>
 * </ul>
...
public interface ITargetConfiguration {
	 ...
	 * <code>filtered</code> is <code>false</code>, then all MCUs supported by tc32-elf-tccas well as
	 ...
	 *            configuration.
	 * @return Set of mcu id values in tc32-elf-tccformat
	 */
	...
	/**
	 * Checks if this target configuration is capable of uploading an TC32 project to a target.
	 * <p>
