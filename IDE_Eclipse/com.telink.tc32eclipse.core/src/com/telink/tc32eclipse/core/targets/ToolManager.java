 ...
 * Purpose:
 * Reference :    
 * $Id: ToolManager.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
...
public class ToolManager implements IRegistryEventListener {
	...
	private final static String			NAMESPACE			= TC32Plugin.PLUGIN_ID;
	...
	public final static String			TC32PROGRAMMERTOOL	= "TC32.tool.programmer";
	public final static String			TC32GDBSERVER		= "TC32.tool.gdbserver";
	 ...
	 * <p>
	 * The list is used by the TC32Plugin class to register the toolmanager as a listener for
