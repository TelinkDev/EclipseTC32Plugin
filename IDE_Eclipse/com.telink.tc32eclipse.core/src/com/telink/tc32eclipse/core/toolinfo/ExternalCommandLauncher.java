 ...
 * Purpose:
 * Reference :   
 * $Id: ExternalCommandLauncher.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
...
import com.telink.tc32eclipse.core.toolinfo.ICommandOutputListener.StreamSource;
...
public class ExternalCommandLauncher {
		...
		if (arguments != null) {
			if (System.getProperty("os.name").toLowerCase().contains("windows")) {
				...
				for (int i = 0; i < arguments.size(); i++) {
					 arguments.set(i, winQuote(arguments.get(i)));    //PS we do have arguments that have space in there for now
					//arguments.set(i, arguments.get(i));
				}
			}
	 ...
	 * programs, like TC32-size.exe write their help output to stderr), or when you like any error
