...
public class FindGPIOCfg {
	 ...
	 */
	public static FindGPIOCfg getDefault() {
		if (instance == null)
			instance = new FindGPIOCfg();
		return instance;
	}
