...
public class FindRFScan {
	 ...
	 */
	public static FindRFScan getDefault() {
		if (instance == null)
			instance = new FindRFScan();
		return instance;
	}
