...
public class WTCDBTools {
	 ...
	 */
	public static WTCDBTools getDefault() {
		if (instance == null)
			instance = new WTCDBTools();
		return instance;
	}
