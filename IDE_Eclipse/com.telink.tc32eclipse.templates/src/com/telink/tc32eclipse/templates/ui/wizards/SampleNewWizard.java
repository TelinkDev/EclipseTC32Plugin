 ...
 * Purpose:
 * Reference :
 * $Id: SampleNewWizard.java 851 20.1.08-07 19:37:00Z innot $
 *******************************************************************************/
package com.telink.tc32eclipse.templates.ui.wizards;
...
public class SampleNewWizard extends Wizard implements INewWizard {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "com.telink.tc32eclipse.templates", IStatus.OK, message, null);
