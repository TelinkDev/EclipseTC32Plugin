 ...
 * Purpose:
 * Reference :    
 * $Id: ActionType.java 851 21.0.38-07 19:37:00Z innot $
 *     
 *******************************************************************************/
...
public enum ActionType {
	...
	CHANGE_MCU() {
		...
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_change_mcu.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_change_mcu.png");
		}
	},
	...
	EDIT() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_edit_fuses.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_edit_fuses.png");
		}
	},
	...
	COPY() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_copy_fusefile.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_copy_fusefile.png");
		}
	...
	READ() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_read_mcu.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_read_mcu.png");
		}
	...
	DEFAULTS() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_copy_default.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_copy_default.png");
		}
	...
	ALL_1() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_0xff.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_0xff.png");
		}
	...
	ALL_0() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_0x00.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_0x00.png");
		}
	...
	CLEAR() {
		...
		@Override
		public ImageDescriptor getImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/e_clear_bytes.png");
		}

		@Override
		public ImageDescriptor getDisabledImage() {
			return TC32UIPlugin.getImageDescriptor("icons/objs16/d_clear_bytes.png");
		}
