 ...
 * Purpose:
 * Reference :   
 * $Id: AbstractTCSectionPart.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
...
public abstract class AbstractTCSectionPart implements ITCEditorPart {
	...
	private class ChangeListener implements ITargetConfigChangeListener {
		...
		/*
		 * (non-Javadoc)
		 * @seecom.telink.tc32eclipse.core.targets.TargetConfiguration.ITargetConfigChangeListener#
		 * attributeChange(com.telink.tc32eclipse.core.targets.ITargetConfiguration, java.lang.String,
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.telink.tc32eclipse.ui.editors.targets.ITCEditorPart#setParent(org.eclipse.swt.widgets.Composite
	 * )
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.telink.tc32eclipse.ui.editors.targets.ITCEditorPart#setMessageManager(org.eclipse.ui.forms
	 * .IMessageManager)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.telink.tc32eclipse.ui.editors.targets.ITCEditorPart#getControl()
	 */
