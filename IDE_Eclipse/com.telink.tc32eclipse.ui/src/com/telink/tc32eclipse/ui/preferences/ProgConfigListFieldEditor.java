 ...
 * Purpose:
 * Reference :  
 * $Id: ProgConfigListFieldEditor.java 851 20.1.08-07 19:37:00Z innot $
 *     
 *******************************************************************************/
...
public class ProgConfigListFieldEditor extends FieldEditor {
	...
	/**
	 * Creates a TCDB Programmers Configuration List field editor.
	 * <p>
	...
	private void editButtonAction(boolean createnew) {
		...
		TCDBConfigEditor dialog = new TCDBConfigEditor(fTableControl.getShell(), config,
				allconfigs);
