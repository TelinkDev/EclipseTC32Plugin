 ...
 * Purpose:
 * Reference :  
 * $Id: TargetConfigurationView.java 851 20.1.08-07 19:37:00Z innot $
 *******************************************************************************/
package com.telink.tc32eclipse.ui.views.targets;
...
import com.telink.tc32eclipse.ui.editors.targets.TCEditorInput;
...
public class TargetConfigurationView extends ViewPart implements ITargetConfigChangeListener {
	...
	private final static String					EDITOR_ID	= "com.telink.tc32eclipse.ui.editors.TargetConfigurationEditor";
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.telink.tc32eclipse.core.targets.TargetConfiguration.ITargetConfigChangeListener#attributeChange
	 * (com.telink.tc32eclipse.core.targets.ITargetConfiguration, java.lang.String, java.lang.String,
	 * java.lang.String)
	 */
	...
	private void showErrorDialog(String message, Throwable exception) {
		IStatus status = new Status(IStatus.ERROR, TC32UIPlugin.PLUGIN_ID, message, exception);
